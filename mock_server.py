...
HTDOCS_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'lib', 'lwip', 'httpd', 'htdocs_xg2010g')

MOCK_UBOOT_VERSION = "U-Boot XG2010G-2026-8-12-g000000000000 (Aug 12 2026 - local preview)"
MOCK_RECOVERY_VERSION = "2026-8-12"
MOCK_CREDIT = "XG2010G port by naoki66; thanks to YYH2913 for the http-uboot recovery"
...
def main():
    ...
    print(f"XG2010G Recovery Mock Server running at http://127.0.0.1:{port}")
